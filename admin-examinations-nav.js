  ...
  if(current==='admin-exams.html'){
    ...
    if(masterPhase1Enabled){
      loadScript('examControlCenterUi','exam-control-center-ui.js?v=20260908-1',()=>{
        loadScript('adminExamControlCenter','admin-exam-control-center.js?v=20260913-1',()=>{
          loadScript('adminExamCredentialsUi','admin-exam-credentials-ui.js?v=20260913-1');
